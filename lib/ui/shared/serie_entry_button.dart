...
class SerieEntryButton extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _SerieEntryButtonState();
  }
}

class _SerieEntryButtonState extends State<SerieEntryButton>
           ...
           focusColor: widget.focusColor ?? Theme.of(context).focusColor,
            focusNode: widget.focusNode,
              child: Transform.scale(
               ...
               SerieViewScreen(video: widget.video)));
