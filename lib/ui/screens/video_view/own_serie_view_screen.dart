...
import 'package:americonictv_tv/ui/screens/video_view/player/own_serie_player_screen.dart';
import 'package:americonictv_tv/ui/screens/video_view/player/serie_palyer_screen.dart';
...
class OwnSerieViewScreen extends StatefulWidget {
  final Playlist video;

  OwnSerieViewScreen({@required this.video});

  @override
  State<StatefulWidget> createState() {
    return _SerieViewScreenState();
  }
}

class _SerieViewScreenState extends State<OwnSerieViewScreen> {
  ...
  void initState() {
    ...
    _videoPlayerController =
        VideoPlayerController.network(widget.video.videos.mp4.low);
  ...
  Future<void> _changeVideoQuality(String videoURL) async {
    ...
    try {
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (BuildContext context) => OwnSeriePlayerScreen(
            UniqueKey(),
